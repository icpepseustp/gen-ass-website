...
export default function Committees() {
    return (
        ...
        <div className='font-mokoto flex flex-col items-center'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-4 font-poppins gap-y-10 lg:px-80'>
        ...
        <div className='flex flex-row justify-center items-center'>
            <img src={logo} width={750} alt="logo" className='-mb-[15px] lg:-mb-[70px] flex justify-content-center'/>
        </div>
